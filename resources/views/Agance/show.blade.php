...
<div class="container">
  ...
  @foreach($all_car as $allcar)
        

          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-30">
              <a href="#"><img  src="{{url('uploads/'.$allcar->filename)}}" alt="{{$allcar->filename}}">
              <div class="card-body">
                <h4 class="card-title ">
                  <a href="#" class="ncolor">{{$allcar->kindofcarhave}}</a>
                </h4>
                <h5>{{$allcar->price}}</h5>
                <p class="card-text">{{$allcar->description}}</p>
                <h6><td>{{$allcar->agancename}}</td></h6>
              </div>
